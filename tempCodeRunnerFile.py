...
game_over_music = r"C:\\Users\\giorgos sani\\Desktop\\cat simulator\\I Go Meow.mp3"
start_music = r"C:\\Users\\giorgos sani\\Desktop\\cat simulator\\I Go Meow.mp3"
jump_sound = pygame.mixer.Sound(r"C:\\Users\\giorgos sani\\Desktop\\cat simulator\\jump.wav")  # Load jump sound
...
WHITE = (255, 255, 255)
BLACK = (0, 0, 0)
DARK_GREEN = (0, 100, 0)  # Define dark green color for the pipes
...
cat = pygame.image.load('C:\\Users\\giorgos sani\\Desktop\\cat simulator\\cat1.png')
cat = pygame.transform.scale(cat, (85, 60))  # Adjusted size for larger screen
cat_rect = cat.get_rect(center=(100, SCREEN_HEIGHT / 2))

# Load and resize background image
background = pygame.image.load('C:\\Users\\giorgos sani\\Desktop\\cat simulator\\street.png')
background = pygame.transform.scale(background, (SCREEN_WIDTH, SCREEN_HEIGHT))

# Load food image and set initial position
food_image = pygame.image.load('C:\\Users\\giorgos sani\\Desktop\\cat simulator\\food.png')
...
def draw_pipes_and_food(pipes_with_food):
    for pipes, food, scored in pipes_with_food:
        pygame.draw.rect(screen, DARK_GREEN, pipes[0], border_radius=15)  # Draw bottom pipe with rounded corners
        pygame.draw.rect(screen, DARK_GREEN, pipes[1], border_radius=15)  # Draw top pipe with rounded corners
        if food:  # Draw food only if it exists
